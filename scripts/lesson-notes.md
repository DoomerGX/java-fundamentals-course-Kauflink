...
## Lección 4 — Métodos, Entrada/Salida e Introducción a POO (12 min)
- **Puntos clave**: Los métodos evitan código repetido. `Scanner` conecta el programa con el usuario.
- Introducir el concepto de clase como "molde" y objeto como "instancia real".
- **Sugerencia**: Hacer que los estudiantes creen una clase `Libro` con `titulo` y `autor`.
...
- **Puntos clave**: Encapsulación con `private`, constructor, getters, setters.
